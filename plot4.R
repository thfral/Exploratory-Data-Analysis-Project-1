...
# Plot 1
plot(power_consumption$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)

# Plot 2
plot(power_consumption$Sub_metering_1, type="l", ylab="Energy Submetering", xlab="")
...
# Plot 3
plot(power_consumption$Voltage, type="l", xlab="datetime", ylab="Voltage")

# Plot 4
plot(power_consumption$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
